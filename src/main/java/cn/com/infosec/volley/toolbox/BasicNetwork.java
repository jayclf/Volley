...
import cn.com.infosec.volley.NetworkError;
...
public class BasicNetwork implements Network {
    ...
    public NetworkResponse performRequest(Request<?> request) throws VolleyError {
        ...
        while (true) {
            ...
            try {
                ...
                //获取响应栏和响应码
                HttpStatusLine statusLine = httpResponse.getStatusLine();
                ...
                if (statusCode == HttpURLConnection.HTTP_NOT_MODIFIED) {
                    ...
                    if (entry == null) {
                        ...
                        return new NetworkResponse(HttpURLConnection.HTTP_NOT_MODIFIED, null, responseHeaders, true, SystemClock.elapsedRealtime() - requestStart);
                    }
                    // 有缓存
                    ...
                    return new NetworkResponse(HttpURLConnection.HTTP_NOT_MODIFIED, entry.data, entry.responseHeaders, true, SystemClock.elapsedRealtime() - requestStart);
                }
     ...
     */
    private void logSlowRequests(long requestLifetime, Request<?> request, byte[] responseContents, HttpStatusLine statusLine) {
    ...
    private void addCacheHeaders(Map<String, String> headers, Cache.Entry entry) {
        ...
        if (entry.lastModified > 0) {
            ...
            headers.put("If-Modified-Since", SimpleDateFormat.getDateTimeInstance().format(refTime));
        }
    }
    ...
    private byte[] entityToBytes(HttpEntity entity) throws IOException, ServerError {
        ...
        try {
            ...
            try {
                // Close the InputStream and release the resources by "close the stream".
                entity.getContent().close();
            } catch (IOException |IllegalStateException e) {
                // This can happen if there was an exception above that left the entity in
                // an invalid state.
                VolleyLog.v("Error occured when calling closeContent");
            }

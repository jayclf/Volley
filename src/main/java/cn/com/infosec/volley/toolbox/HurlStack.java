...
public class HurlStack implements HttpStack {
     ...
     */
    public HurlStack(UrlRewriter urlRewriter, SSLSocketFactory sslSocketFactory, HostnameVerifier hostnameVerifier) {
        mUrlRewriter = urlRewriter;
        mSslSocketFactory = sslSocketFactory;
    ...
    public HttpResponse performRequest(Request<?> request, Map<String, String> additionalHeaders) throws IOException, AuthFailureError {
        ...
        //封装返回状态栏
        HttpStatusLine responseStatus = new HttpStatusLine(protocolVersion, connection.getResponseCode(), connection.getResponseMessage());
        //封装返回信息
        ...
        for (Entry<String, List<String>> header : connection.getHeaderFields().entrySet()) {
            ...
            String value = "";
            for (String valueItem:header.getValue()) {
                value += valueItem;
                value += ";";
            }
            if (value.endsWith(";")) {
